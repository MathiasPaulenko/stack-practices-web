...
1. - [x] **api-documentation-openapi** (recipes)
   - Metrics: 485 imp | pos 34.4 | CTR 0.62% | Δ impr 472
...
37. - [x] **grpc-api** (recipes)
   ...
   - EN: https://stackpractices.com/recipes/grpc-api/
   - ES: https://stackpractices.com/es/recipes/grpc-api/
   - Focus: low CTR, losing impressions
...
44. - [x] **domain-driven-design-guide** (guides)
   - Metrics: 54 imp | pos 35.8 | CTR 0.00% | Δ impr 7
   - EN: https://stackpractices.com/guides/domain-driven-design-guide/
   - ES: https://stackpractices.com/es/guides/domain-driven-design-guide/
   - Focus: high impressions, low CTR
...
47. - [x] **idempotent-api-endpoints** (recipes)
   - Metrics: 17 imp | pos 21.6 | CTR 0.00% | Δ impr -39
   - EN: https://stackpractices.com/recipes/idempotent-api-endpoints/
   - ES: https://stackpractices.com/es/recipes/idempotent-api-endpoints/
   - Focus: low CTR, losing impressions
...
56. - [x] **complete-guide-local-llm-deployment** (guides)
   - Metrics: 54 imp | pos 35.5 | CTR 0.00% | Δ impr 0
   - EN: https://stackpractices.com/guides/complete-guide-local-llm-deployment/
   - ES: https://stackpractices.com/es/guides/complete-guide-local-llm-deployment/
   - Focus: high impressions, low CTR
...
64. - [x] **complete-guide-bundle-size-optimization** (guides)
   ...
   - Focus: striking distance, low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 44.0% / ES 30.7% (0 patterns)
   - Words: 634 | Meta: 155 chars
...
65. - [x] **java-wiremock-stub-external** (recipes)
   ...
   - Focus: low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 47.0% / ES 35.5% (0 patterns)
   - Words: 500 | Meta: 159 chars

66. - [x] **caching** (recipes)
...
67. - [x] **bridge-pattern** (patterns)
   ...
   - Focus: striking distance, low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 48.0% / ES 41.0% (0 patterns)
   - Words: 553 | Meta: 150 chars
...
70. - [x] **react-form-react-hook-form-validation** (recipes)
   ...
   - Focus: low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 45.7% / ES 35.5% (0 patterns)
   - Words: 1668 | Meta: 143 chars
...
71. - [x] **terraform-best-practices-guide** (guides)
   ...
   - Focus: low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 50.3% / ES 42.6% (0 patterns)
   - Words: 1323 | Meta: 149 chars
...
72. - [x] **server-sent-events-go** (recipes)
   ...
   - Focus: proven demand
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 49.1% / ES 34.9% (0 patterns)
   - Words: 1258 | Meta: 146 chars
...
73. - [x] **pipes-and-filters-pattern** (patterns)
   ...
   - Focus: striking distance, low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 52.1% / ES 41.4% (0 patterns)
   - Words: 1629 | Meta: 150 chars
...
74. - [x] **graphql-mocking-apollo-server** (recipes)
   ...
   - Focus: low CTR
   - Status: ✅ Content-improvement workflow applied; ✅ EN/ES aligned; ✅ Build passed; ✅ Desklib EN 43.4% / ES 34.6% (0 patterns)
   - Words: 1198 | Meta: 148 chars
...
81. - [x] **parse-command-line-arguments** (recipes)
