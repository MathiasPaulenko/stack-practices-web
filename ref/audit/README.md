...
| `02-seo-audit.md` | Frontmatter, title, meta, headings, internal links, SERP CTR, schema. |
...
| `06-geo-audit.md` | GEO / AI Search readiness: entidades, hechos, citas, pasajes extraíbles. |
