...
2. **Auditoría SEO técnica**
   - Aplicar `ref/prompts/17-technical-seo-audit.md` al contenido en inglés.
...
3. **Auditoría de calidad de contenido**
   - Aplicar `ref/prompts/18-content-quality-auditor.md` a EN y ES.
...
4. **Detección y corrección de patrones IA**
   ...
   - Aplicar `ref/prompts/ai-detect-analysis.md`.
