...
- **TTFB**: Tiempo de respuesta del servidor — hosting + backend performance.   Consulta [server-side rendering](/recipes/spa-code-splitting-lazy/).
...
2. **Ignorar navegaciones SPA**: Las single-page apps necesitan medición custom de LCP/FID para cambios de ruta. Considera [server-side rendering](/recipes/spa-code-splitting-lazy/).
