...
- **TTFB**: Server response time — hosting + backend performance.  See [server-side rendering](/recipes/spa-code-splitting-lazy/).
...
2. **Ignoring SPA navigations**: Single-page apps need custom LCP/FID measurement for route changes. Consider [server-side rendering](/recipes/spa-code-splitting-lazy/).
