...
- Implementas despliegues blue-green o canary que requieren routing dinámico de tráfico
...
- **Seguridad con mTLS**: Encriptar comunicación service-to-service; autenticar servicios registrados
...
5. **Omitir retries**: Una instancia fallida debería disparar un retry en otra, no fallar el request
...
R: AWS Cloud Map, GCP Service Directory o service registries de API Gateway se integran con Lambda y Cloud Run.

**P: ¿Cuál es la diferencia entre service discovery y load balancing?**
R: El discovery encuentra instancias disponibles; el load balancing distribuye tráfico entre ellas. A menudo trabajan juntas.
