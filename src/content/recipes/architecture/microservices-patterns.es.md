...
- Migrando de un monolito a una arquitectura distribuida con 5+ servicios. Consulta [Guía de Migración](/guides/monolith-to-microservices-migration-guide/) para estrategias de migración.
- Experimentando fallos en cascada donde un servicio lento degrada todo el sistema
- Implementando flujos de pago, gestión de inventario o procesamiento de órdenes entre servicios. Consulta [Saga Pattern](/recipes/saga-pattern/) para transacciones distribuidas.
...
- **Idempotencia para retries**: los retries pueden causar operaciones duplicadas.   Consulta [Endpoints Idempotentes](/recipes/idempotent-api-endpoints/) para patrones de deduplicación.   Sin idempotencia, los retries crean datos inconsistentes.
...
**P: ¿Puedo combinar [circuit breakers](/recipes/circuit-breaker-pattern/) y [retries](/recipes/retry-backoff/)?**
