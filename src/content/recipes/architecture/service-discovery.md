...
- Implementing blue-green or canary deployments that require dynamic traffic routing
...
- **Secure with mTLS**: Encrypt service-to-service communication; authenticate registered services
...
5. **Skipping retries**: One failed instance should trigger a retry on another, not fail the request
...
A: AWS Cloud Map, GCP Service Directory, or API Gateway service registries integrate with Lambda and Cloud Run.

**Q: What's the difference between service discovery and load balancing?**
A: Discovery finds available instances; load balancing distributes traffic among them. They often work together.
