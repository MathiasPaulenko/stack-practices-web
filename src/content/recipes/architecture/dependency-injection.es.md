...
- Implementes arquitecturas de plugins o [patrones de estrategia](/patterns/strategy-pattern/)
...
- **Usa interfaces/protocolos**: Depende de abstracciones, no de tipos concretos. Consulta [Factory Pattern](/patterns/factory-pattern/) para abstracciones de creación de objetos.
...
5. **Dependencias circulares**: Refactoriza en eventos o un [mediador](/patterns/mediator-pattern/) si A depende de B y B de A
