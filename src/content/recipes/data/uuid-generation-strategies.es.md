...
- Las primary keys de [base de datos](/recipes/database-transactions/) deben ser globalmente unicas en sistemas distribuidos
...
- Usa UUID v7 para aplicaciones nuevas que necesiten keys time-sortable. Consulta [Database Migrations](/recipes/database-migrations/) para evolucionar schemas.
...
R: Usa enteros para sistemas single-node donde la coordinacion es trivial. Usa UUIDs para sistemas distribuidos o cuando los identificadores no deben revelar informacion de secuencia. Consulta [Database Connection Pooling](/recipes/database-connection-pooling/) para gestionar conexiones de base de datos.
