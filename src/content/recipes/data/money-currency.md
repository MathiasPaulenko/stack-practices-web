...
- Building e-commerce carts, checkout flows, or invoicing systems. See [Input Validation](/recipes/input-validation/) for sanitizing order data.
...
- Converting between currencies using external [exchange rate APIs](/recipes/call-rest-api/)
...
5. **[Cache exchange rates](/recipes/caching/)** with TTL and timestamp; always convert using the rate that applied at the transaction time.
...
- **Apply money and currency handling** when you need a practical solution for your use case.
