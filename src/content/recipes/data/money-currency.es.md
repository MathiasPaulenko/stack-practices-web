...
- Construyas carritos de e-commerce, flujos de checkout o sistemas de facturación. Consulta [Input Validation](/recipes/input-validation/) para sanitizar datos de ordenes.
...
- Conviertas entre monedas usando [APIs de tasas de cambio externas](/recipes/call-rest-api/)
...
5. **[Cachea tasas de cambio](/recipes/caching/)** con TTL y timestamp; siempre convierte usando la tasa que se aplicaba al momento de la transacción.
