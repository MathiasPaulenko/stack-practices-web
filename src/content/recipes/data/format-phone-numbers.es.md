...
- **Almacena E.164, muestra nacional**: E.
...
- **Almacenar strings formateados**: `(415) 555-2671` es inútil para marcar; almacena E.
...
- **Exponer input crudo en links tel:**: Un link tel con espacios o paréntesis puede fallar en algunos dispositivos; usa E.
...
- For a deeper guide, see [Truncate Text](/es/recipes/truncate-text/).
...
- **Guías relacionadas**: explora las guías de data y formatting para profundizar.
...
- **Aplica formatear números de teléfono** cuando necesites una solución práctica para tu caso de uso.
