...
- Los [backups](/guides/on-call-incident-response-guide/) no deben impactar la performance de la base de datos primaria
...
- **Usa connection pooling**: [PgBouncer](/recipes/connection-pooling/) o ProxySQL manejan el ruteo primaria/réplica
...
R: Sí. `pg_basebackup` desde una réplica descarga la primaria. Asegúrate de que la réplica esté al día primero. Consulta nuestra [plantilla de disaster recovery](/guides/on-call-incident-response-guide/).
