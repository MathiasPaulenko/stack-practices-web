...
Un proyecto gRPC TypeScript funcional necesita el compilador de protobuf, el runtime de gRPC para Node.js,
el generador de TypeScript y un helper pequeño para health checks.
Guardo el proyecto completo en el [repositorio companion](https://github.com/MathiasPaulenko/stack-practices-resources);
buscá bajo `resources/recipes/api/grpc-services-typescript`, pero el `package.json` que necesitás está acá:
