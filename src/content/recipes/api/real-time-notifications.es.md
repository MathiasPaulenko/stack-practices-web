...
- Ejecutas múltiples instancias de API detrás de un [balanceador de carga](/recipes/nginx-reverse-proxy/)
...
- **Difundir a todos los clientes**: Usa [namespaces de room/canal](/patterns/chain-of-responsibility-middleware/) para limitar la entrega de mensajes
- **Ignorar límites de conexión**: Cada WebSocket consume memoria; establece límites por IP y globales
- **Falta de auth en el handshake**: Autentica durante la petición de upgrade con [JWT](/recipes/jwt-authentication/), no después de la conexión
...
- **Aplica construir notificaciones en tiempo real con websockets** cuando necesites una solución práctica para tu caso de uso.
...
R: AWS API Gateway soporta WebSockets, pero las funciones stateless requieren DynamoDB o Redis para compartir información de conexión. Considera [patrones de service mesh](/patterns/ambassador-pattern-services/) para escalar infraestructura en tiempo real.
