...
- Building [REST](/recipes/call-rest-api/) or [GraphQL](/recipes/graphql-api/) APIs that return collections
...
- **Always ORDER BY**: Without ordering, pagination is non-deterministic.  See [SQL Joins](/recipes/sql-joins/) for query optimization.
...
- Using offset pagination on datasets with millions of rows. See [Cursor Pagination](/recipes/cursor-pagination-postgresql/) for growth-ready pagination.
