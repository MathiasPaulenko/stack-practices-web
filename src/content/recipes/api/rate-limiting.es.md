...
- Prevenes ataques de fuerza bruta en endpoints de autenticación
...
- **Usa Redis** para rate limiting distribuido entre múltiples servidores
...
- No documentar límites de rate en la documentación de API
