...
- La infraestructura HTTP existente (cache, auth, LB) debe reutilizarse
...
R: Usa SSE para push de servidor a cliente sobre HTTP. Usa WebSockets cuando necesites comunicacion verdaderamente bidireccional o datos binarios.

**P: Cuantas conexiones SSE concurrentes puede manejar un servidor Node.js?**
R: Miles por proceso, limitado por memoria y file descriptors del OS. Usa clustering o worker threads para escalado horizontal.
