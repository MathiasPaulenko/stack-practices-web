...
- **Guías relacionadas**: explora las guías de api y email para profundizar.
...
- **Aplica enviar emails con smtp** cuando necesites una solución práctica para tu caso de uso.
...
- **SMTP connection pooling**: Setea max pool size a 10 e idle timeout a 30 segundos.
...
- **BCC leakage en bulk emails**: si los bulk emails se envian con todos los recipients en To o Cc, los recipients pueden ver las direcciones de los demas.
