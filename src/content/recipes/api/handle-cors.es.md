...
- Tu frontend (SPA, app móvil, widget de terceros) corre en un origen distinto al de tu [API](/recipes/call-rest-api/)
...
5. Habilitar `allowCredentials` en APIs públicas sin validación de origen, exponiendo endpoints autenticados a sitios maliciosos. Consulta [Checklist de Seguridad de APIs](/guides/api-security-checklist-guide/) para validación de origen.
