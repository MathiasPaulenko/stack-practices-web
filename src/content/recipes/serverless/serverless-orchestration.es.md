...
- Un proceso serverless tiene más de dos pasos dependientes. Consulta [Serverless Functions](/recipes/event-driven-microservices/) para construir unidades de función individuales.
- Los pasos deben reintentarse con backoff ante fallas transitorias. Consulta [Retry Logic](/recipes/retry-backoff/) para patrones de backoff exponencial.
...
- Múltiples funciones deben coordinarse con ramas paralelas y puntos de join. Consulta [Event-Driven Functions](/recipes/event-driven-microservices/) para arquitecturas event-driven.
