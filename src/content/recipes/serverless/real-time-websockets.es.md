...
- Construyas aplicaciones de chat, notificaciones en vivo o feeds en tiempo real. Consulta [Serverless API Gateway](/recipes/nginx-reverse-proxy/) para patrones de endpoints HTTP.
- Transmitas datos en vivo a dashboards o herramientas de monitoreo. Consulta [Event-Driven Functions](/recipes/event-driven-microservices/) para streaming de datos event-driven.
...
- Transmitas eventos desde servicios backend a clientes conectados. Consulta [Scheduled Jobs](/recipes/background-jobs/) para push de datos periódico.
