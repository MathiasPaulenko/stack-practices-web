...
- Reemplazas jobs cron que corren en EC2 o máquinas virtuales. Consulta [Serverless Functions](/recipes/event-driven-microservices/) para deployar código serverless.
- Generando reportes diarios, semanales o mensuales de datos de aplicación. Consulta [Parse JSON](/recipes/parse-json/) para manejar formatos de datos de reportes.
...
- Ejecutando mantenimiento de base de datos (VACUUM, rebuilds de índices, actualizaciones de estadísticas). Consulta [PostgreSQL Query Optimization](/recipes/postgres-query-optimization/) para tuning de rendimiento de base de datos.
