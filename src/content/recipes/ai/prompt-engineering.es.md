...
- Diseñas [chatbots](/recipes/chatbot-openai/), copilotos o [asistentes impulsados por IA](/recipes/ai-agents/)
- Implementando pipelines automatizados de moderación de contenido, resumen o traducción
- Evaluando versiones de prompts con frameworks de [testing A/B](/recipes/load-testing-k6/)
...
R: No. El [prompt engineering](/recipes/prompt-engineering/) es más rápido de iterar y no requiere preparación de datos. El [fine-tuning](/recipes/llm-fine-tuning/) es mejor cuando necesitas comportamiento consistente en un dominio especializado y quieres reducir costos por request.

**P: ¿Puedo forzar a un LLM a siempre outputar JSON válido?**
R: El formato `json_object` de OpenAI y el [function calling](/recipes/ai-agents-tool-use/) enforce estructura JSON, pero el modelo aún puede producir valores semánticamente incorrectos o alucinados. Valida el schema server-side.
