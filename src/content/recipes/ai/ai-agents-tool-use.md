...
|-----------|---------|----------|
| [LangChain Agents](/recipes/ai-agents-tool-use/) | ReAct, Plan-and-Execute | Rapid prototyping |
...
- **Related guides**: explore the ai-agents and ai guides for deeper coverage.
...
- **Apply ai agents with tool use** when you need a practical solution for your use case.
...
A: [RAG](/recipes/semantic-search/) retrieves documents and answers once. Agents can take multiple actions, use tools, and iterate until a goal is met.
