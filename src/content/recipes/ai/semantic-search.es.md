...
- Estás construyendo un motor de recomendación, [sistema de preguntas y respuestas](/recipes/chatbot-openai/) o descubrimiento de contenido
- Quieres combinar búsqueda semántica y por palabras clave ([recuperación híbrida](/recipes/rag-pipeline/))
...
- **Aplica implementar búsqueda semántica con embeddings** cuando necesites una solución práctica para tu caso de uso.
