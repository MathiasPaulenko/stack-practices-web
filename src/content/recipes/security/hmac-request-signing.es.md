...
- Aseguras que payloads de [webhooks](/recipes/event-driven-microservices/) no han sido alterados
...
5. **Almacenar secretos en variables de entorno sin encriptar**: Usa un [secret manager](/recipes/vault-dynamic-credentials/)

## Preguntas Frecuentes

**P: ¿Es HMAC mejor que JWT para auth de servicio a servicio?**
R: HMAC es más simple y stateless para servicios internos. JWT es mejor cuando necesitas claims de identidad y verificación por terceros. Para una visión completa de seguridad de API, consulta el [checklist de seguridad API](/guides/api-security-checklist-guide/).
