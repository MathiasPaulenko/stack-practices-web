...
- **Monitor rejected requests**: a sudden spike in 429 responses may indicate an attack or a client bug. Alert on rate-limiting events via your [monitoring stack](/guides/monitoring-alerting-guide/).
...
A: Basic rate limiting helps against application-layer (L7) DDoS but cannot stop volumetric network floods (L3/L4). Combine rate limiting with [CDN DDoS protection](/recipes/caching/) and WAF rules.
