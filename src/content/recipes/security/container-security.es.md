...
- **Multi-stage builds**: No envíes build tools (gcc, git) en imágenes de producción
...
4. **Secrets en ENV**: `ENV AWS_SECRET_ACCESS_KEY=...` es visible para cualquiera que haga pull de la imagen
