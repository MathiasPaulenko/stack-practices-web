...
- Los developers agregan [dependencias](/guides/security-best-practices-guide/) sin revisar su postura de seguridad
...
- **Multi-stage builds**: No envíes build tools (gcc, git) en imágenes de producción. Consulta [infraestructura inmutable](/guides/infrastructure-as-code-guide/).
...
4. **Secrets en ENV**: `ENV AWS_SECRET_ACCESS_KEY=...` es visible para cualquiera que haga pull de la imagen. Sigue [secrets management](/guides/security-best-practices-guide/).
