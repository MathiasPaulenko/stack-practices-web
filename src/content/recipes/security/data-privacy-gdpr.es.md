...
- **Encripta PII en reposo**: Usa [AES-256](/recipes/encryption-at-rest/) para bases de datos, S3 y backups
- **Loguea acceso a datos personales**: [Audita](/guides/logging-monitoring-observability-guide/) quién accedió qué y cuándo
...
1. **Consentimiento implícito**: Checkboxes pre-marcadas o términos escondidos no cuentan bajo [GDPR](/recipes/data-privacy-gdpr/)
2. **Sin límites de retención**: Mantener datos de usuario para siempre viola limitación de almacenamiento
3. **Filtración a terceros**: Analytics, ads y CDNs reciben PII sin conocimiento del usuario. Ejecuta [auditorías de dependencias](/guides/security-best-practices-guide/) regularmente.
