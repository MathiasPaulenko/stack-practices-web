...
R: CSP controla qué recursos puede cargar un navegador cuando renderiza tu página. [CORS](/recipes/handle-cors/) controla si otros orígenes pueden hacer requests *a* tu API. Son complementarios, no sustitutos.
