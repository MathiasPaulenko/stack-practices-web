...
- Developers add [dependencies](/guides/security-best-practices-guide/) without reviewing their security posture
...
- **Multi-stage builds**: Don't ship build tools (gcc, git) in production images. See [immutable infrastructure](/guides/infrastructure-as-code-guide/).
...
4. **Secrets in ENV**: `ENV AWS_SECRET_ACCESS_KEY=...` is visible to anyone who pulls the image. Follow [secrets management](/guides/security-best-practices-guide/).
