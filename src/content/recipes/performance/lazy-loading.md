...
- **Forgetting server-side rendering**: if a lazy component is needed for SSR or initial paint, it will block rendering.  Consider [SPA code splitting](/recipes/performance/spa-code-splitting-lazy) for above-the-fold content.
