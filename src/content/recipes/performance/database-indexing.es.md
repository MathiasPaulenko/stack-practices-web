...
- **Indexa columnas de foreign key**: las bases de datos no siempre indexan automáticamente foreign keys.   Índices faltantes en columnas `JOIN` causan escaneos costosos de nested loop.   Consulta [diseño de bases de datos](/guides/database-design-guide/).   Consulta [SQL Joins](/recipes/sql-joins/) para optimización de joins.
...
- **Ignorar el mantenimiento de índices**: los índices fragmentados en tablas de alta rotación se degradan con el tiempo.   Consulta [tuning SQL](/guides/sql-performance-tuning-guide/).   Programa `REINDEX` o `OPTIMIZE TABLE` periódicamente.
...
- [Patrones de Batch Processing](/recipes/batch-processing-patterns/) — optimización de operaciones bulk de datos
- [Rendimiento Web](/recipes/web-performance/) — técnicas de rendimiento frontend y backend
- [Load Testing](/recipes/load-testing/) — validación del rendimiento de bases de datos bajo carga
