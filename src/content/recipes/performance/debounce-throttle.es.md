...
- Apliques [rate-limiting](/recipes/rate-limiting/) a llamadas a APIs disparadas por acciones de usuario (spam de botón, autocomplete)
...
5. **Mide el impacto** — usa la pestaña Performance de DevTools para verificar que tu debounce/throttle reduce realmente el trabajo del main thread. Consulta [optimización de rendimiento](/guides/performance-optimization-guide/).

## Errores Comunes

1. Usar debounce donde se necesita throttle, causando que eventos intermedios importantes se pierdan completamente.
2. Olvidar limpiar timers al desmontar componentes, causando memory leaks y ejecuciones obsoletas. Consulta [optimización de rendimiento](/guides/performance-optimization-guide/).
