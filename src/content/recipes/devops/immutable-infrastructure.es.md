...
3. **Almacenar secrets en imágenes**: Bakear credenciales en AMIs y containers crea exposición permanente. Sigue [pautas de secrets management](/guides/security-best-practices-guide/).
