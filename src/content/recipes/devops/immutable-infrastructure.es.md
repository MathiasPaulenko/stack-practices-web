...
- **Escanea imágenes antes del deploy**: Trivy, Clair o Snyk en pipeline de CI
...
3. **Almacenar secrets en imágenes**: Bakear credenciales en AMIs y containers crea exposición permanente
...
R: Para servidores de app stateless, sí. Para bases de datos, usa configuración inmutable + volúmenes de datos persistentes, no datos inmutables.
