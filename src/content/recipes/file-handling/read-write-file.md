...
- Loading configuration or data files at startup. See [Parse JSON](/recipes/parse-json/) for structured config files.
...
- Creating temporary files for intermediate processing in data pipelines. See [Call REST API](/recipes/call-rest-api/) for downloading remote data.
