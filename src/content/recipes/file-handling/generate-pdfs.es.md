...
- Necesites generar facturas, recibos o confirmaciones de orden. Consulta [Export CSV Excel](/recipes/export-csv-excel/) para exportación de datos tabulares.
- Los usuarios soliciten reportes o exports de analíticas descargables. Consulta [Background Jobs](/recipes/background-jobs/) para generación asíncrona de PDFs.
- Debas producir documentos legalmente compliant (contratos, certificados). Consulta [Email Templates MJML](/recipes/email-templates-mjml/) para entrega profesional por email.
- Quieras reutilizar diseños HTML/CSS existentes para salida impresa. Consulta [Image Optimization](/recipes/image-optimization/) para optimización de imágenes embebidas.
