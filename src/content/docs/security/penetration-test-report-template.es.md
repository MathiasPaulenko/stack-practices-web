...
- For alternatives, see [Vulnerability Management Process Template](/es/docs/vulnerability-management-process-template/).
...
| PTES (Penetration Testing Execution Standard) | Metodología general |
