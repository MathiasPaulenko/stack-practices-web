...
- **Guías relacionadas**: explora las guías de serverless y cost para profundizar.
...
- **Aplica plantilla de estimacion de costos serverless** cuando necesites una solución práctica para tu caso de uso.
...
- [Serverless Cold Start Runbook](/es/docs/serverless-cold-start-runbook/)
