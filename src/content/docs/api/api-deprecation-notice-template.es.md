...
- **Guías relacionadas**: explora las guías de api y deprecation para profundizar.
...
- **Aplica plantilla de aviso de deprecacion de api** cuando necesites una solución práctica para tu caso de uso.
