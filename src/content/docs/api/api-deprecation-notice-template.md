...
- **Related guides**: explore the api and deprecation guides for deeper coverage.
...
- **Apply api deprecation notice template** when you need a practical solution for your use case.
