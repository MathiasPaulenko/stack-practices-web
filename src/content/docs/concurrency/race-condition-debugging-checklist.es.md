...
- [Coordinate Concurrent Tasks with Communicating](/es/recipes/csp-communication/)
- [Concurrent Patterns with Go Goroutines and Channels](/es/recipes/go-goroutines-channels-patterns/)
