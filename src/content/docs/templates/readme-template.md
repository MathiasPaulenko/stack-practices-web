...
| **Internal Tool** | [Onboarding](/docs/onboarding-guide-template/), Internal Slack channel | License, Contributing |
...
- **Include a changelog link** — users need to know what changed between versions. Use [Changelog Template](/docs/changelog-template/) for structure.
