...
Usa esta plantilla para escribir user stories listas para desarrollo y testing.
...
- **Escribe criterios de aceptación antes del código** — son el contrato entre producto e ingeniería
...
- **Incluye criterios no funcionales** — performance, seguridad y accesibilidad también son criterios de aceptación
...
- Sin definición de done — los equipos discrepan sobre cuándo una historia está terminada
...
A veces, pero reframéala. "Como desarrollador, quiero actualizar el ORM para obtener patches de seguridad y queries más rápidas" es válida. "Actualizar ORM" es una tarea, no una historia. Siempre conecta el trabajo técnico con valor de usuario o desarrollador.
