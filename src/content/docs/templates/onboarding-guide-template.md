...
- **Related guides**: explore the automation and ci-cd guides for deeper coverage.
...
- **Apply onboarding guide template** when you need a practical solution for your use case.
