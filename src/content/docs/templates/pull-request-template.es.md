...
- **Guías relacionadas**: explora las guías de code-review y devops para profundizar.
...
- **Aplica plantilla de pull request** cuando necesites una solución práctica para tu caso de uso.
