...
---
Usa esta plantilla para definir targets de confiabilidad que equilibran felicidad de usuarios con velocidad de ingeniería. Consulta la [Guía de Monitoreo y Alertas](/guides/monitoring-alerting-guide/) para recolección de métricas y la [Guía de Respuesta a Incidentes On-Call](/guides/on-call-incident-response-guide/) para procedimientos de escalamiento.
...
- **Empieza con métricas visibles para usuarios** — "uso de CPU" no es un SLI; "tasa de requests exitosos" sí. Consulta la [Guía de Monitoreo y Alertas](/guides/monitoring-alerting-guide/) para selección de métricas.
...
- Ignorar quema de presupuesto de error — el presupuesto existe para proteger velocidad de ingeniería, no para ignorarse. Consulta la [Plantilla de Postmortem de Incidente](/docs/incident-postmortem-template/) para cuando los SLOs se incumplen.
