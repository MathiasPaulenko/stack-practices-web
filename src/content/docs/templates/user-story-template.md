...
- **Related guides**: explore the product-management and template guides for deeper coverage.
...
- **Apply user story and acceptance criteria template** when you need a practical solution for your use case.
