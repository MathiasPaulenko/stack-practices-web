...
description: "Plantilla de código de conducta comunitaria para establecer estándares de colaboración inclusivos y respetuosos."
...
- Quieres construir una comunidad inclusiva
- Tu organización requiere estándares de comportamiento explícitos
...
también cuando un individuo representa oficialmente a la comunidad en espacios
públicos.

## Cumplimiento

Los casos de comportamiento abusivo, acosador o inaceptable pueden ser reportados
a los líderes de la comunidad responsables del cumplimiento en [email].
...
| Sección | Propósito |
|---------|-----------|
| **Compromiso** | Compromiso de la comunidad con la inclusión |
| **Estándares** | Comportamientos positivos y negativos explícitos |
| **Cumplimiento** | Quién maneja violaciones y cómo |
...
- **Hazlo visible**: Enlaza prominentemente en el [README](/docs/readme-template/) y repositorio
...
- **Aplica plantilla de código de conducta** cuando necesites una solución práctica para tu caso de uso.
...
Sí. Incluso los proyectos pequeños se benefician de expectativas claras. Combínalo con una [Guía de Contribución](/docs/contributing-guide/) y [README](/docs/readme-template/) para establecer expectativas desde el inicio. Previene malentendidos y crea un ambiente acogedor para nuevos colaboradores de diversos orígenes.
