...
- **Related guides**: explore the testing and load-testing guides for deeper coverage.
...
- **Apply load test report template** when you need a practical solution for your use case.
