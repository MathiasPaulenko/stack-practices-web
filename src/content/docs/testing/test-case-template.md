...
- **Related guides**: explore the testing and test-case guides for deeper coverage.
...
- **Apply test case template** when you need a practical solution for your use case.
