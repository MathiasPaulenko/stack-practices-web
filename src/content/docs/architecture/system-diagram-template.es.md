...
- **Guías relacionadas**: explora las guías de architecture y visualization para profundizar.
...
- **Aplica plantilla de diagramas de sistema** cuando necesites una solución práctica para tu caso de uso.
