...
- For alternatives, see [SLA Definition Template](/es/docs/sla-definition-template/).
...
- **Aplica plantilla de engineering handbook** cuando necesites una solución práctica para tu caso de uso.
