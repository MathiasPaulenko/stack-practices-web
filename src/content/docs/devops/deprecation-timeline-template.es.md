...
- **Guías relacionadas**: explora las guías de deprecation y legacy para profundizar.
...
- **Aplica plantilla de linea de tiempo de deprecacion** cuando necesites una solución práctica para tu caso de uso.
