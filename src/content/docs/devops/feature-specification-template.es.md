...
- **Guías relacionadas**: explora las guías de specification y requirements para profundizar.
...
- **Aplica plantilla de especificacion de feature** cuando necesites una solución práctica para tu caso de uso.
