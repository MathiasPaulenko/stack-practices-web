...
- **Related guides**: explore the capacity-planning and forecasting guides for deeper coverage.
...
- **Apply capacity planning forecast template** when you need a practical solution for your use case.
