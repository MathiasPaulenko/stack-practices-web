...
- **Guías relacionadas**: explora las guías de adr y architecture para profundizar.
...
- **Aplica plantilla de architecture decision record (adr)** cuando necesites una solución práctica para tu caso de uso.
