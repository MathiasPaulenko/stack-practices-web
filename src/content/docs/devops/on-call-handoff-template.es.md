...
- **Guías relacionadas**: explora las guías de on-call y runbook para profundizar.
...
- **Aplica plantilla de entrega de guardia (on-call handoff)** cuando necesites una solución práctica para tu caso de uso.
