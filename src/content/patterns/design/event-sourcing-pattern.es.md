...
- [CQRS](/patterns/cqrs-pattern/) esté en uso, y los modelos de lectura puedan construirse desde proyecciones de eventos
- Necesites compensar fallas reproduciendo o invirtiendo eventos (consulta [Saga](/patterns/saga-pattern/))
...
- **Aplica patrón event sourcing** cuando necesites una solución práctica para tu caso de uso.
...
R: Después de cada N eventos, guarda el estado computado de la entidad. Al rehidratar, carga el último snapshot y reproduce solo los eventos posteriores a este. Esto mantiene el tiempo de reproducción constante. Consulta [CQRS](/patterns/cqrs-pattern/) para patrones de modelos de lectura que funcionan bien con Event Sourcing.
