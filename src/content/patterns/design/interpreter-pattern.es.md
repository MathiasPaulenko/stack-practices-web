...
| **[Visitor](/patterns/visitor-pattern/) + Interpreter** | Separa la lógica de evaluación de los nodos del árbol | Cuando las estrategias de evaluación varían |
...
R: Sí, y a menudo deberías. El Patrón Interpreter define la estructura del AST; el [Patrón Visitor](/patterns/visitor-pattern/) agrega operaciones (interpretar, serializar, optimizar) sin modificar los nodos del AST.
