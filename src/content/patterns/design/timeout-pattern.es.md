...
- Siempre combínalo con [Retry](/patterns/retry-pattern/) para problemas transitorios, y [Circuit Breaker](/patterns/circuit-breaker-pattern/) para fallas crónicas
...
- **Combina con [Circuit Breaker](/patterns/circuit-breaker-pattern/)** — si los timeouts son frecuentes, deja de llamar al servicio fallido
...
R: Sí, si la operación es idempotente y el timeout podría haber sido causado por un problema transitorio de red. Pero si los timeouts son frecuentes, combínalo con [Circuit Breaker](/patterns/circuit-breaker-pattern/) para evitar reintentos desperdiciados en un servicio crónicamente lento.
