...
R: Relacionados pero diferentes. [Observer](/patterns/observer-pattern/) es una dependencia uno-a-muchos donde los sujetos notifican a los observadores. Mediator centraliza la comunicación muchos-a-muchos. Un event bus puede servir como ambos.

**P: ¿Cuál es la diferencia entre Mediator y Facade?**
R: [Facade](/patterns/adapter-pattern/) proporciona una interfaz simplificada a un subsistema. Mediator coordina la comunicación entre objetos pares. Facade es sobre simplificar acceso; Mediator es sobre desacoplar pares.
