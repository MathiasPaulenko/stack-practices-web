...
| **[Command](/patterns/command-pattern/) + Memento** | Comandos almacenan mementos para deshacer | Sistemas transaccionales, editores |
...
R: [Prototype](/patterns/prototype-pattern/) crea un nuevo objeto copiando uno existente. Memento guarda el estado de un objeto para poder restaurarlo más tarde. Prototype es sobre duplicación; Memento es sobre viajar en el tiempo.
