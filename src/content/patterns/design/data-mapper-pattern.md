...
A: [Active Record](/patterns/active-record-pattern/) bundles data and persistence in the same class. Data Mapper separates them into a distinct mapper object.
