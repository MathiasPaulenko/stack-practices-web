...
- Considera librerias de state management (Redux, Zustand) como mediadores evolucionados
...
R: Observer es broadcast one-to-many. Mediator es many-to-many enrutado a traves de un coordinador central.
