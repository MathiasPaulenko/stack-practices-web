...
| **[Abstract Factory](/patterns/abstract-factory-pattern/)** | Families of related objects | Complex, but handles product families |
...
A: [Factory Method](/patterns/factory-pattern/) lets subclasses decide which class to instantiate. [Abstract Factory](/patterns/abstract-factory-pattern/) creates families of related objects (e.g., UI components for Windows vs. Mac).

**Q: Is the Factory Pattern the same as dependency injection?**
A: No. [DI](/patterns/dependency-injection-pattern/) is about who provides the dependency; Factory is about how the dependency is created. They often work together.
