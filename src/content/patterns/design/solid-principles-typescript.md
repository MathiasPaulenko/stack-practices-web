...
---
The [SOLID](/guides/solid-principles-guide/) principles provide a framework for writing maintainable object-oriented code. When applied to TypeScript, they help prevent the common pitfalls of tightly coupled classes, brittle inheritance hierarchies, and unmaintainable dependency graphs.
...
Software entities should be open for extension but closed for modification. Use composition and interfaces instead of modifying existing code. See [Strategy](/patterns/strategy-pattern/) and [Decorator](/patterns/decorator-pattern/) for practical examples.
...
Depend on abstractions, not concrete implementations. Use constructor injection to make dependencies explicit and testable. See [Dependency Injection](/patterns/dependency-injection-pattern/) for wiring patterns.
