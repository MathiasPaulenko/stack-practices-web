...
| **[Abstract Factory](/patterns/abstract-factory-pattern/)** | Familias de objetos relacionados | Complejo, pero maneja familias de productos |
...
A: [Factory Method](/patterns/factory-pattern/) permite que las subclases decidan qué clase instanciar. [Abstract Factory](/patterns/abstract-factory-pattern/) crea familias de objetos relacionados (ej. componentes UI para Windows vs. Mac).

**Q: ¿Es el Factory Pattern lo mismo que la inyección de dependencias?**
A: No. [DI](/patterns/dependency-injection-pattern/) se trata de quién provee la dependencia; Factory se trata de cómo se crea la dependencia. A menudo funcionan juntos.
