...
| **[Contenedor DI](/patterns/dependency-injection-typescript/)** | Framework resuelve e inyecta automáticamente | Aplicaciones grandes (Spring, Angular, .NET Core) |
...
- **Guías relacionadas**: explora las guías de dependency-injection y decoupling para profundizar.
...
- **Aplica patrón dependency injection** cuando necesites una solución práctica para tu caso de uso.
...
R: No. Para proyectos pequeños, la inyección manual por constructor es suficiente. Consulta [DI Container en TypeScript](/patterns/dependency-injection-typescript/) para una implementación liviana. Los frameworks de DI como Spring, Angular injector o InversifyJS brillan en aplicaciones grandes con muchos servicios interdependientes.

**P: ¿Cómo ayuda DI con el testing?**
R: Al depender de abstracciones (interfaces), puedes inyectar implementaciones mock o stub durante las pruebas. Consulta [unit testing](/recipes/unit-testing/) para patrones de testing. Esto aísla la clase bajo prueba de sus colaboradores reales.
