...
- **Related guides**: explore the identity and pattern guides for deeper coverage.
...
- **Apply federated identity pattern** when you need a practical solution for your use case.
