...
[Traces](/recipes/distributed-tracing/) reveal where latency actually lives. A p99 of 500ms might be 400ms in payment and 100ms everywhere else.
...
3. **What should I do?** — link to [runbook](/guides/technical-documentation-strategy-guide/) or suggested action
...
- **Instrument before you need it** — adding metrics during an [incident](/guides/on-call-incident-response-guide/) is too late
...
- **Test your [runbooks](/guides/technical-documentation-strategy-guide/)** — a runbook that has not been tested in 6 months is probably wrong
...
- No post-[incident](/guides/on-call-incident-response-guide/) metric review — after every incident, ask "what metric would have caught this earlier?"
...
- **Related guides**: explore the alerting and alerts guides for deeper coverage.
...
- **Apply monitoring and alerting — metrics, logs, and dashboards** when you need a practical solution for your use case.
