...
- **Establece [requests y limits de recursos](/guides/performance-optimization-guide/)** en cada contenedor para prevenir vecinos ruidosos
...
- **Usa ConfigMaps para configuración**, [Secrets](/guides/security-best-practices-guide/) para credenciales
- **Establece terminación graceful** — maneja SIGTERM en tu app (`terminationGracePeriodSeconds`). Consulta [estrategias de deployment](/guides/deployment-strategies-guide/).

## Errores Comunes

- No establecer requests/limits de recursos, causando inestabilidad del cluster
- Usar etiquetas de imagen `latest`, llevando a [despliegues](/guides/deployment-strategies-guide/) impredecibles
