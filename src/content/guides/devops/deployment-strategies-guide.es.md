...
- **Automatiza rollback** — un humano presionando un botón a las 3 AM es poco confiable
- **Usa tráfico sintético** — golpea el canary con tests automatizados antes que usuarios reales
