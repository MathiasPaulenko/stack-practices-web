...
**Never commit secrets to Git.** Use [secret managers](/guides/security-best-practices-guide/) (AWS Secrets Manager, HashiCorp Vault, GitHub Secrets) and inject at runtime.
