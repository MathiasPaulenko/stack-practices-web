...
Infrastructure as Code (IaC) is the practice of managing and provisioning infrastructure through machine-readable definition files rather than manual configuration. It turns infrastructure changes into repeatable, reviewable, and versioned operations. See [CI/CD Pipeline](/guides/cicd-pipeline-guide/) for deployment automation. This guide compares declarative and imperative approaches, covers Terraform and Pulumi, and provides what works for production use.
...
- **Never commit secrets** — use [secret managers](/guides/security-best-practices-guide/) (AWS Secrets Manager, Vault) and reference by ARN
