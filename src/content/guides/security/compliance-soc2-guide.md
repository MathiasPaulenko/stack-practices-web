...
- **Related guides**: explore the soc2 and compliance guides for deeper coverage.
...
- **Apply soc 2 compliance — basics for engineering teams** when you need a practical solution for your use case.
