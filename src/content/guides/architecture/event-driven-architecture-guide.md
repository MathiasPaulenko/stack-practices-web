...
Separate read and write models. Writes go to the command model; reads come from optimized read models populated by events. See [database design](/guides/database-design-guide/).
...
- **Apply event-driven architecture — queues, topics, and streams** when you need a practical solution for your use case.
