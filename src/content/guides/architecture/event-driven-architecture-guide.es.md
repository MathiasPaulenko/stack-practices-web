...
Separa modelos de lectura y escritura. Las escrituras van al modelo de comando; las lecturas vienen de modelos de lectura optimizados poblados por eventos. Consulta [diseño de bases de datos](/guides/database-design-guide/).
