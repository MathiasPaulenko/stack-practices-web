...
- For alternatives, see [Onion Architecture — Dependency Inversion in Practice](/es/guides/onion-architecture-guide/).
...
- **Guías relacionadas**: explora las guías de hexagonal-architecture y ports-and-adapters para profundizar.
...
- **Aplica arquitectura hexagonal — puertos, adaptadores y testabilidad** cuando necesites una solución práctica para tu caso de uso.
