...
- **Related guides**: explore the data and data-warehouse guides for deeper coverage.
...
- **Apply data lake vs data warehouse — architecture guide** when you need a practical solution for your use case.
