...
- **Related guides**: explore the hexagonal-architecture and ports-and-adapters guides for deeper coverage.
...
- **Apply hexagonal architecture — ports, adapters, and testability** when you need a practical solution for your use case.
