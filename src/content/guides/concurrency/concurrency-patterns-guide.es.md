...
Usa async/await para tareas I/O-bound ([HTTP calls](/guides/rest-api-design-guide/), [sistema de archivos](/recipes/read-write-file/), bases de datos). Usa threads o procesos para trabajo CPU-bound (cálculos, procesamiento de datos) que necesita ejecución paralela.
