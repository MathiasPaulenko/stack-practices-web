...
| **Presión de diseño** | El código debe ser testeable, lo cual tiende hacia [diseños desacoplados y modulares](/guides/solid-principles-guide/) |
...
- **Saltar el paso de refactor** — el tercer paso es donde mejora el [código limpio](/guides/clean-code-principles-guide/)
