...
- **Related guides**: explore the clickhouse and metrics guides for deeper coverage.
...
- **Apply time-series databases — influxdb, timescaledb** when you need a practical solution for your use case.
