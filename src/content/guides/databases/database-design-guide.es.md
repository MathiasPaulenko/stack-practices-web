...
- **Planificar el crecimiento**: [particionar tablas grandes](/guides/database-sharding-partitioning-guide/) antes de que se conviertan en un problema

## Errores Comunes

- Saltarse la normalización por "performance" sin evidencia. Consulta [tuning SQL](/guides/sql-performance-tuning-guide/).
