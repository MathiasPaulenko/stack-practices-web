...
- **Plan for growth**: [partition large tables](/guides/database-sharding-partitioning-guide/) before they become a problem

## Common Mistakes

- Skipping normalization for "performance" without evidence. See [SQL performance tuning](/guides/sql-performance-tuning-guide/).
...
- **Apply database design guide** when you need a practical solution for your use case.
