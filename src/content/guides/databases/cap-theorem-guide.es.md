...
- Usar una base CP para una carga de trabajo AP (o viceversa) — empareja la herramienta al requerimiento. Consulta [selección NoSQL](/guides/nosql-database-selection-guide/).
