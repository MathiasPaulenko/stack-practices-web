...
const html = fs.readFileSync('dist/es/recipes/scheduled-jobs/index.html', 'utf8');
...
console.log('\nJSON-LD:', jsonld.length, 'total:', jsonld.reduce((a, m) => a + m[0].length, 0));
...
console.log('Code blocks:', preBlocks.length, 'total:', preBlocks.reduce((a, m) => a + m[0].length, 0));
