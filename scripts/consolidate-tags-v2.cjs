...
const TAGS_TO_REMOVE = new Set([
  ...
  'infrastructure-as-code', // covered by 'infrastructure'
  'iac',                 // covered by 'infrastructure'
  'cloud',               // covered by 'infrastructure'
  'haproxy',             // covered by 'load-balancer'
  'vcl',                 // covered by 'load-balancer'
  'load-balancing',      // synonym of 'load-balancer'

  // --- Recipes: databases ---
  'mysql',               // covered by 'databases'
  'alembic',             // covered by 'migrations'
  'data-recovery',       // covered by 'soft-deletes'
  'joins',               // covered by 'sql'
  'optimistic-locking',  // covered by 'concurrency'
  'database-views',      // covered by 'databases'
  'materialized-views',  // covered by 'databases'
  'cache-invalidation',  // covered by 'cache'
  'edge-caching',        // covered by 'cdn'
  'connection-pooling',  // covered by 'database-pooling'
  'database-encryption', // covered by 'encryption'

  // --- Recipes: concurrency ---
  'go-routines',         // covered by 'concurrency'
  'channels',            // covered by 'concurrency'
  'cpu-bound',           // covered by 'concurrency'
  'blocking-queue',      // covered by 'concurrency'
  'event-loop',          // covered by 'async'

  // --- Recipes: general / misc ---
  'decimal',             // covered by 'data-types'
  'pub-sub',             // covered by 'messaging'
  'bullmq',              // covered by 'background-jobs'
  'dynamic',             // covered by 'sitemap'
  'generation',          // covered by 'sitemap'
  'health-check',        // covered by 'devops'
  'config',              // covered by 'environment-variables'
  'configuration',       // covered by 'environment-variables'
  'code-quality',        // covered by 'pre-commit-hooks'
  'git-hooks',           // covered by 'pre-commit-hooks'
  'templates',           // covered by 'email-templates'
  'html-to-pdf',         // covered by 'pdf-generation'
  'excel',               // covered by 'file-handling'
  'files',               // covered by 'file-handling'
  'stream-processing',   // covered by 'file-handling'
  'file-upload',         // covered by 'file-handling'
  'bandwidth',           // covered by 'compression'
  'toggles',             // covered by 'feature-flags'
  '12-factor-app',       // covered by 'devops'
  'argparse',            // covered by 'cli'
  'argument-parsing',    // covered by 'cli'
  'scripting',           // covered by 'bash'

  // --- Recipes: security / testing / serverless ---
  'sql-injection',       // covered by 'security'
  'cold-start',          // covered by 'serverless'
  'scheduled-jobs',      // covered by 'cron'
  'cloud-functions',     // covered by 'serverless'
  'distributed-workflows', // covered by 'serverless'
  'durable-functions',   // covered by 'serverless'
  'e2e-testing',         // covered by 'testing'
  'integration-testing', // covered by 'testing'
  'junit',               // covered by 'unit-testing'
  'baseline',            // covered by 'visual-testing'
  'chromatic',           // covered by 'visual-testing'
]);
