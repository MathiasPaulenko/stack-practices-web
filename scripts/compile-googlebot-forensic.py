...
**Approach:** Emulate Googlebot using Playwright (headless Chromium), compare raw and rendered HTML, crawl local static build.""",
    ...
    f"- **Metadata duplication (15%)**: {len(issues['duplicateTitles'])} duplicate titles, {len(issues['duplicateDescs'])} duplicate descriptions.",
